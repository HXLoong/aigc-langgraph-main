...
metadata:
  source: .claude/skills/sync-dify-prompts/SKILL.md
  argument_hint: <dify-yaml-dir>
---

> 自动生成自 `.claude/skills/sync-dify-prompts/SKILL.md`（python scripts/sync_agents_md.py），禁止手改。 文中 `$1`、`$2` 指调用本技能时用户按顺序给出的第 1、2 个参数。
