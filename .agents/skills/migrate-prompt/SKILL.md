...
metadata:
  source: .claude/skills/migrate-prompt/SKILL.md
  argument_hint: <dify-yaml-path> <node-title> [category]
---

> 自动生成自 `.claude/skills/migrate-prompt/SKILL.md`（python scripts/sync_agents_md.py），禁止手改。 文中 `$1`、`$2` 指调用本技能时用户按顺序给出的第 1、2 个参数。
