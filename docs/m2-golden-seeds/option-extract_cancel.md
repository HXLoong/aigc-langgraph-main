# Golden 种子收集 · option.extract_cancel

> grill-with-docs 2026-05-10 第 4 决策落地 · 业务方填空，工程师转 jsonl

## 节点描述

**期权撤单参数提取（合并 cancel_order_request + request_cancel_order）。**

| 字段 | 值 |
|---|---|
| 节点 | `option.extract_cancel` |
| product_type | `option` |
| 合法 intent 枚举 | `cancel_order_request`, `request_cancel_order` |
