...
| 合法 intent 枚举 | `close_order_query`, `close_order_request`, `close_order_confirm`, `close_order_cancel_request`, `close_order_cancel_confirm`, `close_order_order_query` |
