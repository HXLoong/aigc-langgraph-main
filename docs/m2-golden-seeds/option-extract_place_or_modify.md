# Golden 种子收集 · option.extract_place_or_modify

> grill-with-docs 2026-05-10 第 4 决策落地 · 业务方填空，工程师转 jsonl

## 节点描述

**期权下单/改单参数（共用 schema，靠 expected_action 区分）。**

| 字段 | 值 |
|---|---|
| 节点 | `option.extract_place_or_modify` |
| product_type | `option` |
| 合法 intent 枚举 | `place_order_from_quote`, `request_modify_order` |
