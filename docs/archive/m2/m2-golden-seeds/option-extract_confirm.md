# Golden 种子收集 · option.extract_confirm

> grill-with-docs 2026-05-10 第 4 决策落地 · 业务方填空，工程师转 jsonl

## 节点描述

**期权三种确认参数提取（合并版，靠 expected_action 区分）。**

| 字段 | 值 |
|---|---|
| 节点 | `option.extract_confirm` |
| product_type | `option` |
| 合法 intent 枚举 | `confirm_order`, `confirm_cancel_order`, `confirm_modify_order` |
