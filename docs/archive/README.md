...
| `history/` | 历史叙事与被取代的手册:Dify 迁移记(v1)、ticker 图重构记、ticker 操作手册(ReAct 版,已被 DSL v2 resolver 管线取代)、高质量 LangGraph 项目复盘;ADR 实施记录归档(`adr-implementation-log-2026-09.md`,2026-09-24 ADR 精简时从正文迁出) | 2026-03~09 |
