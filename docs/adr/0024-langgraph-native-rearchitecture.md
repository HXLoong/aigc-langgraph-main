...
- 撤销"改业务逻辑必须先改 Dify 源再同步"与"冲突永远选 Dify 原始版本"；dify/yaml/ 与 docs/archive/dify-originals/ 冻结（已打 tag `dify-assets-frozen-20260917` 后移除，见附录 C 级与落地记录）。
