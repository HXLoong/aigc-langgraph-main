...
用法：
    ...
    python scripts/convert_jsonl_to_excel.py --input tests/fixtures/categories/tr-data
...
默认读取 ``tests/fixtures/categories/tr-data``，输出该目录下的“黄金数据集.xlsx”。
...
DEFAULT_INPUT = REPO_ROOT / "tests" / "fixtures" / "categories" / "tr-data"
