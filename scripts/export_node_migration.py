...
MAPPINGS = {
    ...
    "1776160580437": mapping("互换-节点-下单", "LLM+Code", "app/subgraphs/swap/place_order.py:swap_extract_candidates app/subgraphs/swap/place_order.py:swap_normalize app/subgraphs/swap/place_order.py:swap_place_result", prompts="swap/place_order", tests="tests/subgraphs/swap/test_place_evidence.py tests/subgraphs/swap/test_fresh_counterparty_graph.py", product="swap", intent="place_order_request"),
    ...
    "1779330004958": mapping("期权-节点-询价", "LLM+Code", "app/subgraphs/option/extract_inquiry.py:inquiry_extract app/subgraphs/option/extract_inquiry.py:inquiry_normalize app/subgraphs/option/extract_inquiry.py:inquiry_submit", prompts="option/extract_inquiry", tests="tests/subgraphs/option/test_inquiry_evidence.py", product="option", intent="new_inquiry"),
    ...
    "1780652892832": mapping("互换-选择标的", "LLM+Code", "app/subgraphs/swap/select_ticker.py:swap_select_ticker app/subgraphs/swap/selection_rules.py:ticker_choice", prompts="swap/select_ticker", tests="tests/subgraphs/swap/test_selection_evidence.py", note="明确范围优先 Code；引用序号只取对应候选，新 directRef 原文交 Java 识别，不做本地查库。"),
...
TOOLS = {
    ...
    "1764752539169": "app/llm/clients.py:get_qwen_structured",
    "1764841677781": "app/llm/clients.py:get_qwen_structured",
    ...
    "1776160580437": "app/llm/clients.py:get_qwen_complex",
    "1776755680654": "app/tools/option_client.py:OptionClientHttpx.query_close_orders",
    "1779330004958": "app/llm/clients.py:get_qwen_thinking",
    ...
    "1780652892832": "app/llm/clients.py:get_qwen_complex",
}
