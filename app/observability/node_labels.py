...
NODE_LABELS: dict[str, NodeLabel] = {
    ...
    "swap_resolve": NodeLabel("互换订单标的解析", "hybrid"),
    ...
    "inquiry_precheck": NodeLabel("期权询价标的预检查", "io"),
    "inquiry_reject": NodeLabel("期权询价拒绝处理"),
    "inquiry_extract": NodeLabel("期权询价要素抽取", "llm"),
    "inquiry_normalize": NodeLabel("期权询价参数归一化"),
    "inquiry_resolve": NodeLabel("期权询价标的解析", "hybrid"),
    ...
    "ticker": NodeLabel("共享标的解析", "graph"),
    "extract_candidates": NodeLabel("标的候选词准备"),
    "infer_codes": NodeLabel("标的代码候选推断", "llm"),
    "split_keywords": NodeLabel("标的关键词拆分", "llm"),
    "judge_type": NodeLabel("标的类别识别", "llm"),
    "merge_candidates": NodeLabel("标的候选合并与权威校验", "io"),
    "resolve_org_item": NodeLabel("单个标的查询与排序", "hybrid"),
    "assemble": NodeLabel("标的解析结果汇总"),
}
